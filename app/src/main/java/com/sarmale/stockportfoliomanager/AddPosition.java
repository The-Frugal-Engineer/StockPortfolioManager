...
public class AddPosition extends AppCompatActivity {
    ...
    public void addPosition(View view) {
        ...
        Integer auxNumberStocks = Integer.parseInt(numberStocks.getText().toString());
        ...
        //When creating LastStockPrice==AcquisitionPrice
        userStockPosition.setLastStockPrice(auxStockPurchasePrice);
